...
import com.compfest.aiapplication.createFile
import com.compfest.aiapplication.databinding.ActivityCameraBinding
...
class CameraActivity : AppCompatActivity() {
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({ cameraFutureAction(cameraProviderFuture) }, ContextCompat.getMainExecutor(this))
    }

    private fun cameraFutureAction(provider: ListenableFuture<ProcessCameraProvider>) {
        ...
        try {
            ...
            cameraProvider.bindToLifecycle(this, cameraSelector, preview, capturedImage)
        } catch (e: Exception) {
    ...
    private fun takeImage() {
        val imageCapture = capturedImage ?: return
