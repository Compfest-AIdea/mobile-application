...
@Database(entities = [PredictionTabularInput::class, PredictionImageInput::class, PredictionTabularResult::class, PredictionImageResult::class], version = 1, exportSchema = false)
